...
namespace DL
{
    ...
    public partial class BRodriguezControlEscolarEntities : DbContext
    {
        public BRodriguezControlEscolarEntities()
            : base("name=BRodriguezControlEscolarEntities")
        {
        }
        ...
        public virtual int AlmunoMateriaDelete(Nullable<int> idAlumno, Nullable<int> idMateria)
        {
            var idAlumnoParameter = idAlumno.HasValue ?
                new ObjectParameter("IdAlumno", idAlumno) :
                new ObjectParameter("IdAlumno", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AlmunoMateriaDelete", idAlumnoParameter, idMateriaParameter);
        }
    }
}
